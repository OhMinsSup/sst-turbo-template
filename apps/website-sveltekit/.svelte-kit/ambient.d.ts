...
declare module '$env/static/private' {
	...
	export const SOLANA_HOME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_prettier: string;
		TMPDIR: string;
		CPPFLAGS: string;
		npm_package_scripts_lint: string;
		npm_package_devDependencies__template_vite: string;
		...
		npm_package_devDependencies__template_tailwind_config: string;
		...
		npm_package_devDependencies__template_eslint_config: string;
		...
		FNM_DIR: string;
		npm_package_devDependencies__template_prettier_config: string;
